...
try {
        ...
        if (global.DATABASE._data.users[m.sender].stamina < 100) {
        	if (global.DATABASE._data.users[m.sender].ayamg >= count * 1) {
                            global.DATABASE._data.users[m.sender].ayamg -= count * 1
                           ////// global.DATABASE._data.users[m.sender].healt += snyawa * count
                            global.DATABASE._data.users[m.sender].stamina += spertamina * count
        ...
        if (global.DATABASE._data.users[m.sender].stamina < 100) {
        	if (global.DATABASE._data.users[m.sender].ayamb >= count * 1) {
        ...
        if (args[0] === 'leleb') {
        	////if (global.DATABASE._data.users[m.sender].healt < 100) {
        if (global.DATABASE._data.users[m.sender].stamina < 100) {
        	if (global.DATABASE._data.users[m.sender].leleb >= count * 1) {
