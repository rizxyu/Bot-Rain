...
🔖 Aattp <teks>
🔖 Aattp2 <teks> (Limit)
🔖 Acustomtahta <teks> (Limit)
🔖 Actrigger <text> (Limit)
🔖 Agetexif
🔖 Aglitch <teks> (Limit)
🔖 Akiss
🔖 Ametalicglow <teks> (Limit)
🔖 Aneon <teks> (Limit)
🔖 Aphlogo <text|text>
🔖 Aphotooxy <effect|teks> (Limit)
🔖 Apubglogo teks|teks
🔖 Apubgserti <teks>
🔖 Apubgserti2 <teks>
🔖 Arainbowglow <teks> (Limit)
🔖 Arainbowshine <teks> (Limit)
🔖 Arealisticcloud <teks> (Limit)
🔖 Asemoji [tipe] <emoji>
🔖 Asfire (Limit)
🔖 Astiker (caption|reply media)
🔖 Astiker <url>
🔖 Astikergif (caption|reply media)
🔖 Astikergif <url>
🔖 Astikerline <url> (Limit)
🔖 Astikerly <pencarian> (Limit)
🔖 Astikertelegram <url> (Limit)
🔖 Astickfilter (caption|reply media) (Limit)
🔖 Astickmaker (caption|reply media) (Limit)
🔖 Asurgaserti <teks>
🔖 Atext3d <teks>
🔖 Atext3d2 <teks>
🔖 Atogif (reply)
...
🔖 Awm <packname>|<author>
🔖 Awolflogo <text|text>
🔖 Awolfmetal <teks> (Limit)
🔖 Awoodenboard <teks> (Limit)
🔖 Amagernulis1 <teks> (Limit)
🔖 Amagernulis2 <teks> (Limit)
🔖 Amagernulis3 <teks> (Limit)
🔖 Amagernulis4 <teks> (Limit)
🔖 Amagernulis5 <teks> (Limit)
🔖 Amagernulis6 <teks> (Limit)
🔖 Anulis <teks>
🔖 Aquotemaker <teks>|<wm> (Limit)
🔖 Aquotemaker2 <teks | wm> (Limit)
🔖 Atahta2<teks>
🔖 Agay
🔖 Ahornycard
🔖 Ahornylicense
