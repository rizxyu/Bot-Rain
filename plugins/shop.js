            ...
            case 'buy':
                switch (_type) {
                    case 'potion':
                        ...
                        break
case 'pancing':
if (global.DATABASE._data.users[m.sender].pancing == 1 ) throw 'Lu dah punya'
                        if (global.DATABASE._data.users[m.sender].money >= pancing * count) {
                            global.DATABASE._data.users[m.sender].pancing += count * 1
                            global.DATABASE._data.users[m.sender].money -= pancing * count
